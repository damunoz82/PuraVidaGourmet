...
public class CategoriaRecetaRepository extends BaseRepository<CategoriaReceta> {
  ...
  public static final RowMapper<CategoriaReceta> rowMapper = (rs, rowNum) -> CategoriaReceta.builder()
          .id(rs.getInt("id"))
  ...
  @Override
  public void prepareStatement(PreparedStatement ps, CategoriaReceta receta) throws SQLException {
